...
This Poisson deviance expresses how much the model deviates from a model that just reproduces the data, i.e., you take the observed number of claims as the average number of claims for each policy holder.

In order to better grasp the performance of the model on unseen data, we do a train test split. 
